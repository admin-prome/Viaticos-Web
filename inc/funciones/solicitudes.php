...
function enviar_mail_imprimir_solicitud($id_solicitud,$fecha,$id_usuario)
{
   ...
   // $para = "laureano@marketingplus.com.ar";
    ...
    $mensaje   = "Su solicitud numero <b>" . $id_solicitud .  "</b> presentada el dia ".$fecha."."
              . " aun no ha sido impresa ,ingrese en el siguiente link <a href='http://rendicion.provinciamicroempresas.com/solicitudes_autorizadas.php' target='_blank'> http://rendicion.provinciamicroempresas.com/solicitudes_autorizadas.php</a>,e imprimas las solicitudes correspondientes."
