...
<div class="separador" style="margin-top: 20px!important;">
     <h3> Viaticos exportados del usuario <b style="color:gray;"><?= $_SESSION['nombre_usuario']; ?></h3>
...
if ($solicitudes_exportadas) {
    foreach ($solicitudes_exportadas as $row) {
