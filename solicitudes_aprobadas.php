...
$solicitudes_aprobadas = usuario_solicitudes_aprobadas($id_usuario);
?>
...
?>
    <h3>Vi&aacute;ticos presentados por <span style="color:gray; font-weight:bold;"><?= $_SESSION['nombre_usuario']; ?></span> correspondientes al mes de <b><?php echo obtener_nombre_mes($solicitudes_aprobadas[0]['mes']); ?></b>
        del <?php echo $solicitudes_aprobadas[0]['ano']; ?></h3>
<?php
}else{echo('<h3>Solicitudes aprobadas</h3>');}
?>
    <div style="background-color: #eeeced;margin-top:10px;">
        ...
        <table id="table_datatable" class="display" cellspacing="0" width=" width: 800px;
            ...
            <tbody>
                ...
                $divsComentarios = '';
                if ($solicitudes_aprobadas) {
                    foreach ($solicitudes_aprobadas as $row) {
