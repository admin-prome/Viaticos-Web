...
<div style="background-color: #eeeced;">
    <table id="tabla_tope" class="display" cellspacing="0" style="width: 0px auto;">
        ...
        <tbody>
            ...
            <tr>
                <td>Tope Guarderia Ley</td>
                <td>
                    <input type="text" size="8" maxlength="5"
                           id="tope_guarderia_ley_<?= CM; ?>"  value="<?= obtener_tope_almuerzo_cena_segun_sucursal(CM, 'tope_guarderia_ley'); ?>" />
                </td>
                <td><input type="submit" class="botones guardar" value="Guardar" id="tope_guarderia_ley-<?= CM; ?>" /></td>
            </tr>
        </tbody>
