...
<div class="separador">
    ...
    <table id="detalle_solicitud" class="display" cellspacing="0" data-page-length='50' style="width:100%; margin:0 auto;">
        ...
        <tbody>
            ...
            if ($viaticos) {
                foreach ($viaticos as $row) {
                    ...
                    if ($row["destino"]) {
                        echo("<td><span style='cursor: pointer;' class='ver_mapa' id=" . $row["cargado_en_celular"] . '@' . $row["origen"] . '@' . guion($row["destino"]) . '@' . $row["id"] . '@admin'.">Ver mapa</span></td>");
                    } else {
                        echo("<td> - </td>");
                    }
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        coords_sucursal =<?php echo('"'.$coords_sucursal_usuario.'"'); ?>;
